...
import {
  Calendar, Clock, MapPin, Upload, CheckCircle2, FileText,
  Send, ChevronRight, AlertCircle, Tag, ExternalLink, QrCode,
  Building2, ArrowLeft, Eye
} from "lucide-react";
...
export function FacilitatorInterface() {
  ...
  const [organization, setOrganization] = useState("IT Student Council");
  ...
  // Form State - Step 2: Digital Assets
  const [regLink, setRegLink] = useState("");
  const [qrFileName, setQrFileName] = useState("");

  // Form State - Step 3: Clearances
  ...
  // Local state for Facilitator's tracking list
  ...
  const handleSubmitProposal = () => {
    // Format to match PendingEvent expected by Admin Coordinator Queue
    const newProposal = {
      id: Date.now(),
      title,
      organization,
    ...
    // Save to shared localStorage bridge for the Admin Queue
  ...
  return (
    <div className="flex-1 flex flex-col bg-[#0B132B] text-white overflow-hidden">
          ...
          <div className="w-full max-w-2xl">
            ...
            {step === 2 && (
              <div className="bg-[#1C2541] border border-white/10 rounded-xl p-6 space-y-4">
                ...
                <div>
                  <label className="text-xs text-white/70 block mb-1">Registration Link (Forms / Portal) *</label>
                  <input
                    type="url"
                    value={regLink}
            ...
            {/* Step 3: Clearances & Paper Checklist */}
            {step === 3 && (
              ...
              <div className="bg-[#1C2541] border border-white/10 rounded-xl p-6 space-y-4">
                ...
                <div className="bg-[#0B132B] p-4 rounded-lg space-y-2.5 text-xs">
                  ...
                  <div className="flex justify-between border-b border-white/5 pb-2">
                    ...
                    <a href={regLink} target="_blank" rel="noreferrer" className="text-[#4A90D9] underline truncate max-w-[200px]">
                      {regLink}
                    </a>
                  </div>
